...
class DailyMail():
    ...
    def __init__(self):
        ...
        self.recipients_list = ['sendto@gmail.com',] # receiver's email address
        self.sender_credentials = {'email': 'abcd@abcd.com', # your sender email address
    ...
    ### Generating Plain Text ###
        text = f'<-- Daily Brief - {datetime.date.today().strftime("%d %b %Y")} -->\n\n'
