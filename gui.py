...
from sendemail import DailyMail
...
class DailyDigestGUI:
    ...
    def __init__(self, root):
        # build the GUI #
        self.__root = root
        self.__root.title('Daily Brief')
        title_label = ttk.Label(self.__root, text = ' \U0001F4DC Daily Brief \U0001F4DC',
        ...
        self.__scheduler = DailyScheduler()
